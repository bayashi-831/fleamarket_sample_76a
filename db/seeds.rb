...
men                          = Genre.create(name: "メンズ")
baby_kids                    = Genre.create(name: "ベビー・キッズ")
interior_residence_accessory = Genre.create(name: "インテリア・住まい・小物")
book_music_game              = Genre.create(name: "本・音楽・ゲーム")
toy_hobby_goods              = Genre.create(name: "おもちゃ・ホビー・グッズ")
cosme_perfume_beauty         = Genre.create(name: "コスメ・香水・美容")
appliance_smartphone_camera  = Genre.create(name: "家電・スマホ・カメラ")
sport_leisure                = Genre.create(name: "スポーツ・レジャー")
handmade                     = Genre.create(name: "ハンドメイド")
ticket                       = Genre.create(name: "チケット")
car_motorcycle               = Genre.create(name: "自動車・オートバイ")
